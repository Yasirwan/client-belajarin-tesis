...
import { createDoubtz, getDoubtzData } from "../../Redux/doubt/actionz";

import Navbar from "../../Components/Sidebar/Navbar";
import Header from "../../Components/Header/Header";
import AddIcon from "../../Components/AddIcon/AddIcon";
import DoubtzBox from "../../Components/DoubtBox/DoubtzBox";
...
const Doubtsz = () => {
  ...
  const { doubtz, load } = useSelector((store) => store.doubtz);
  ...
  const handleSubmit = () => {
    ...
    console.log(obj);
    setLoading(true);
    dispatch(createDoubtz(obj)).then((res) => {
      if (res.msg == "Error") {
        setLoading(false);
        messageApi.open({
          type: "info",
      ...
      <div className="content">
        ...
        <div className="contentData">
          {doubtz
            ...
            .map((data, i) => {
              return <DoubtzBox data={data} key={i} />;
            })}
        </div>
