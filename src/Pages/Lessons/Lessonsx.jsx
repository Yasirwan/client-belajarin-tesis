...
import ava_salsa from '/img/ava_salsa.jpg';
    ...
    <div className="lessonsx">
      ...
      <div className="hero-section">
        ...
        <div className="hero-information" data-aos="fade-left" data-aos-delay="500">
          <h1>Inovasi dalam Pembelajaran, Kunci untuk Masa Depan Gemilang</h1>
          <p>
            BelajarIn mempermudah proses belajar dengan media interaktif, kuis seret-lepas, dan umpan balik instan. Didukung Model Problem Based Learning, setiap siswa dibimbing untuk belajar optimal dan berkembang maksimal.          </p>
          {/* <button>
              <a href="../html/login_page.html">Sign Up Now! </a>
            </button> */}
          <button onClick={() => navigate('/login')} className="p-2 my-2" style={{ backgroundColor: '#1E0342' }}>Mari Mulai</button>
        </div>
      </div>
          ...
          <div className="main-box">
            ...
            <div className="main-center">
              ...
              <div className="profile-text rounded-lg px-8 py-3 text-left">
                ...
                <p>Saya Yasir, seorang Analis Data dengan keahlian dalam mengolah, menganalisis, dan memvisualisasikan data untuk mendukung pengambilan keputusan. Terampil menggunakan SQL, Python, Excel, dan Tableau, saya berpengalaman menangani proyek analitik end-to-end serta bekerja sama dengan berbagai pemangku kepentingan. Siap berkontribusi menghadirkan insight yang berdampak bagi perusahaan.</p>
      ...
      <div className="footer">
        ...
        <div className="bottom-information1">
          <div className="bottom-left">
            <h1>Mulai Pengalaman Belajar</h1>
            <p>Algoritma</p>
            <p>Pemrograman</p>
            <p>Percabangan</p>
            <p>Perulangan</p>
